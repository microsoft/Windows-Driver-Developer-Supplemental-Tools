...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, KMDFTestTemplateQueueInitialize)
#endif

NTSTATUS
KMDFTestTemplateQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = KMDFTestTemplateEvtIoDeviceControl;
    queueConfig.EvtIoStop = KMDFTestTemplateEvtIoStop;
...
VOID
KMDFTestTemplateEvtIoDeviceControl(
    _In_ WDFQUEUE Queue,

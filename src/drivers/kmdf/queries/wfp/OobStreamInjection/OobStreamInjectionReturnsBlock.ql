...
where not exists(ActionTypeExpr exp | isBlockExpression(exp))
select waf,
  "Stream Injection Classify Function: " + waf.getName() +
    " does not explicity set an FWPS_ACTION_TYPE to FWP_ACTION_BLOCK " +
    "in the FWPS_CLASSIFY_OUT structure."

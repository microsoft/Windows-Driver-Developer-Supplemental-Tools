...
where isBlockExpression(blk)
select waf,
  "Flow Established Callout Classify Function: " + waf.getName() +
    " sets an FWPS_ACTION_TYPE to FWP_ACTION_BLOCK. This is a contract violation. " +
    blk.getLocation().getFile() + ". Line: " + blk.getLocation().getStartLine()

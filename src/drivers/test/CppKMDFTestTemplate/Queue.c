...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, CppKMDFTestTemplateQueueInitialize)
#endif

NTSTATUS
CppKMDFTestTemplateQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = CppKMDFTestTemplateEvtIoDeviceControl;
    queueConfig.EvtIoStop = CppKMDFTestTemplateEvtIoStop;
...
VOID
CppKMDFTestTemplateEvtIoDeviceControl(
    _In_ WDFQUEUE Queue,

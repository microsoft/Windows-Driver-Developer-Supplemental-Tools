...
#pragma alloc_text (PAGE, KMDFTestTemplateEvtDeviceAdd)
...
--*/
{
    ...
    attributes.EvtCleanupCallback = KMDFTestTemplateEvtDriverContextCleanup;

    WDF_DRIVER_CONFIG_INIT(&config,
                           KMDFTestTemplateEvtDeviceAdd
                           );
...
--*/
{
    ...
    status = KMDFTestTemplateCreateDevice(DeviceInit);
...
VOID
KMDFTestTemplateEvtDriverContextCleanup(
